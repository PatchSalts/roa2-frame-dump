...
- There is no way to exit the training menu (required to toggle hitboxes) while staying in Frame Advance mode; perhaps entering the Frame Advance mode should be a part of the character scripts' responsibilities?
